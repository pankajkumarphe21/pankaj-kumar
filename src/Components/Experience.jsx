...
const Experience = () => {
  return (
    <div className='mt-[60px]'>
      <h1 className='w-[100%] font-semibold flex justify-center text-4xl mt-[90px]'>Experience</h1>
      <h1 className='w-[100%] font-semibold flex justify-center text-lg mt-[9px]'>Bringing a blend of innovation, expertise, and dedication to every project, ensuring impactful results</h1>
      <div className='w-[100%] mt-[20px] flex gap-[50px] justify-center items-center'>
      <CgToolbox className='text-7xl'/>
      <div className='bg-[#212121] h-[320px] w-[800px] shadow-xl rounded-3xl'>
        <h1 className='mt-[20px] ml-[45px] text-3xl font-semibold'>Spirit, IIT BHU</h1>
        <div className='flex justify-between mt-[10px] mx-[30px]'>
          <p className='text-blue-500'>Technical Team Manager</p>
          <p>January 2023 - Apr 2023</p>
        </div>
        <div className="w-[100%] flex justify-center mt-[5px]">
        <div className="flex bg-white h-[1px] opacity-10 w-[736px] justify-center"></div>
        </div>
        <ul className="list-disc ml-[60px] w-[80%] mt-[20px]">
