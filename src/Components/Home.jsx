        ...
        <div className="w-[47%] max-sm:w-[90%] py-[11%] pl-[12%] max-sm:py-[22%] flex flex-col">
          ...
          <div className="flex mt-[50px]">
            ...
            <div className="h-[86px] cursor-pointer hover:scale-105 w-[96px] border-2 ml-[20px] rounded-lg flex flex-col items-center">
              ...
              <a target="_blank" href="https://drive.google.com/file/d/1OktQbLPEaAU19UwqLRuXnt3qystpu80w/view?usp=sharing" className="mt-[5px] text-sm">Download</a>
              <a target="_blank" href="https://drive.google.com/file/d/1OktQbLPEaAU19UwqLRuXnt3qystpu80w/view?usp=sharing" className="text-sm">Resume</a>
            </div>
