  ...
  return (
    <div className='contact sm:h-screen w-[100%] text-black mt-[60px]'>
      ...
      <div className='flex max-sm:flex-col max-sm:items-center justify-center gap-[2%]'>
        ...
        <a target='_blank' href='https://drive.google.com/file/d/1OktQbLPEaAU19UwqLRuXnt3qystpu80w/view?usp=sharing' className='bg-white hover:border-2 hover:border-black border-2 border-white text-2xl py-5 px-10 max-sm:text-xl rounded-md'>
          Download Resume
        </a>
      </div>
      </div>
