...
const About = () => {
  return (
    <div className='mt-[60px] flex w-[100%]'>
      ...
      <div className='mt-[30px] w-[70%] flex-col items-center justify-center'>
        ...
        <div className='flex mt-[50px] text-2xl'>
        <p className='ml-[103px] flex'><p className='text-yellow-500'>Based in </p>: India </p>
